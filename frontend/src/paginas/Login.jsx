        ...
        <>
            ...
            <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
                ...
                <nav className="mt-10 lg:flex lg:justify-between">
                    <Link className='block text-center my-5 text-gray-600' to="/registrar">¿No tienes una cuenta? Regístrate</Link>
                    <Link className='block text-center my-5 text-gray-600' to="/olvide-password">¿Olvidaste tu contraseña?</Link>
                </nav>
            </div>
        </>
    );
